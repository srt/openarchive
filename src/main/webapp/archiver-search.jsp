...
<head>
    <title>
        <fmt:message key="archiver.search.title"/>
    </title>
    <meta name="pageID" content="archiver-search"/>
...
<form action="archiver-search.jsp" method="post">
            ...
            <tr valign="top">
                <td>
                    <table>
                        <tr>
                            <td colspan="2"><b>
                                <fmt:message key="archiver.search.participants"/>
                            </b></td>
                        </tr>
                        <tr valign="top">
                            <td>
                ...
                <td>
                    <table>
                        <tr>
                            <td colspan="4"><b>
                                <fmt:message key="archiver.search.dateRange"/>
                            </b></td>
                        </tr>
                        <tr valign="top">
                            <td>
                                <fmt:message key="archiver.search.start"/>
                            </td>
                            <td>
                                ...
                                <span class="jive-description"><fmt:message
                                        key="archiver.search.start.description"/></span>
                            </td>
                ...
                <td>
                    <table>
                        <tr>
                            <td colspan="1"><b>
                                <fmt:message key="archiver.search.keywords"/>
                            </b></td>
                        </tr>
                        <tr valign="top">
                            <td>
                                ...
                                <span class="jive-description"><fmt:message
                                        key="archiver.search.keywords.description"/></span>
                            </td>
                        </tr>
                    </table>
                </td>
    ...
    <input type="submit" name="search" value="<fmt:message key="archiver.search.submit"/>"
    ...
    <tr>
        ...
        <td width="60%">
            <div id="conversationLogBlank">
                <br/>
                <p style="text-align:center;"><fmt:message key="archiver.search.selectConversation"/></p>
            </div>
            <div id="conversationLog" style="display:none;">
                <div id="conversationHeader">
                    <span class="small-label"><fmt:message key="archiver.search.participants"/>:</span>
                    <span class="small-text" id="conversation-participants"></span><br/>
                    <span class="small-label"><fmt:message key="archiver.search.date"/>:</span>
                    <span class="small-text" id="conversation-date"></span><br/>
                    <span class="small-label"><fmt:message key="archiver.search.duration"/>:</span>
...
<script type="text/javascript">
    ...
    function checkDateRange()
    {
        ...
        {
            alert("<fmt:message key="archiver.search.error.endBeforeStart"/>")
